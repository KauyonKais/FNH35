...
$EndSheet
$Sheet
S 10000 1650 650  550 
U 5B8B1EF6
F0 "LEDMatrix_perKey" 60
F1 "LEDMatrix_perKey.sch" 60
F2 "SDI" I L 10000 1750 50 
F3 "CKI" I L 10000 1850 50 
F4 "VCC" I L 10000 2000 50 
F5 "GND" I L 10000 2100 50 
F6 "SDO" I R 10650 1750 50 
F7 "CKO" I R 10650 1850 50 
$EndSheet
$Comp
...
F2 "SDI" I L 10000 950 50 
F3 "CKI" I L 10000 1050 50 
F4 "VCC" I L 10000 1200 50 
F5 "GND" I L 10000 1300 50 
F6 "SDO" I R 10600 950 50 
F7 "CKO" I R 10600 1050 50 
$EndSheet
$Comp
...
F 1 "+5V" V 9965 1328 50  0000 L CNN
...
F 1 "+5V" V 8265 2228 50  0000 L CNN
...
Wire Wire Line
	8300 1950 8250 1950
Text Label 8350 4950 0    79   Italic 16
TODO:_CHECK_PINS_FOR_RELEVANCE
Wire Wire Line
	7450 1850 8300 1850
Wire Wire Line
	7450 1850 7450 3050
...
Wire Wire Line
	7150 950  7150 3050
$Comp
L crumpschemes:74AHCT125 U?
U 1 1 5C1CB2A7
P 8800 1450
F 0 "U?" H 8775 2237 60  0000 C CNN
F 1 "74AHCT125" H 8775 2131 60  0000 C CNN
